...
To run the frontend, Node.js must be installed. If it isn't, see [Initial setup](/docs/start-here/initial-setup/) and follow it to set up the database as well.
