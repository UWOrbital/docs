...
5. Just like that you have the backend setup! To do a sanity check try running our test suite for the backend and see if the tests pass. Use the following commands from the root of the respository:
    ```shell
