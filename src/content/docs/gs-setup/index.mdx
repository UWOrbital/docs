...
4. (Highly Recommended) If you are working with the database, you should set it up as well. The guide can be found below in the [Database Setup section](#database-setup). 
...
8. From the root directory, run the following command to initialize your database with the correct schema:
    ...
    cd ..
    ```
    Your database should now be setup! Now you can revisit the [Backend Setup section](#backend-setup) and do the remaining steps (Step 5 and 6)
