...
Make sure you follow the [Initial setup](/docs/start-here/initial-setup) guide.
:::
...
8. Ensure that your Python virtual environment is activated. If not, follow [Initial setup](/docs/start-here/initial-setup). Start the backend in development mode by running `fastapi dev gs/backend/main.py` from the root directory. This will also initialize the database.
</Steps>
