...
After installing WSL, continue to the [Linux/WSL/Mac](#linuxwslmac) section of the guide.
:::
...
If not, open a terminal and run the following commands to install Git:
    ...
    ```
2. Follow one of the guides below to setup your development environment.
</Steps>
