...
Welcome to the UW Orbital Docs! Here you will find all codebase-related documentation.
...
Our ground station code includes frontends that operators can interact with as well as software that interfaces with the satellite. The ground station stack is primarily built with Python (FastAPI) and React.

The satellite code includes firmware for the onboard computer (OBC) and electrical systems, such as the BMS (Battery Management System). This is a major part of the codebase and allows the software team to support the work of the mechanical and electrical subteams.

## Suggested guides
Don't know where to go first? Try one of the following links!

<LinkCard title="Initial setup" href="/docs/start-here/initial-setup/" />
<LinkCard title="Style guide" href="/docs/start-here/style-guide/" />
<LinkCard title="File structure overview" href="/docs/start-here/file-structure/" />
